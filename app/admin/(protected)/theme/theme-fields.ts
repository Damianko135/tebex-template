...
export const THEME_TOKEN_FIELDS: ThemeTokenField[] = [
  ...
  { key: "destructive-foreground", label: "Destructive foreground", group: "Core" },
  { key: "success", label: "Success", group: "Core" },
  { key: "success-foreground", label: "Success foreground", group: "Core" },
  { key: "warning", label: "Warning", group: "Core" },
  { key: "warning-foreground", label: "Warning foreground", group: "Core" },
